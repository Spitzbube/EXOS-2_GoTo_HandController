...
typedef enum
{
	MENU_SOLAR_SYSTEM_MERCURY = 0,
	MENU_SOLAR_SYSTEM_VENUS = 1,
	MENU_SOLAR_SYSTEM_MARS = 2,
	MENU_SOLAR_SYSTEM_JUPITER = 3,
	MENU_SOLAR_SYSTEM_SATURN = 4,
	MENU_SOLAR_SYSTEM_URANUS = 5,
	MENU_SOLAR_SYSTEM_NEPTUNE = 6,
	MENU_SOLAR_SYSTEM_PLUTO = 7,
	MENU_SOLAR_SYSTEM_SUN = 8,
	MENU_SOLAR_SYSTEM_MOON = 9,

} MENU_SOLAR_SYSTEM_OBJECT;
