	...
	switch (a)
	{
		case 11:
			...
			switch (b)
			{
				case 1:
					//0x23240
					Data_400033a8 = Data_40002f30;
					Data_400033ac = Data_40002f34;
					Data_400033b0 = Data_40002f38;
					Data_400033b4 = Data_40002f3c;
					break;

				case 2:
					//0x23288
					Data_400033a8 = Data_40002f34;
					Data_400033ac = Data_40002f38;
		...
		case 12:
			...
			switch (b)
			{
				case 1:
					//0x234c8
					Data_400033a8 = Data_40002f5c;
					Data_400033ac = Data_40002f60;
